...
namespace Pomodoro_Technique_Android.Backend
{
    ...
    {
        /* NOTE: Async void is intentional here. This provides a way to call an async method from the constructor while
         communicating intent to fire and forget, and allow handling of exceptions */
